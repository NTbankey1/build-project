...
with st.sidebar:
    ...
    github_token = st.text_input("GitHub Token", type="password", help="Create a token with repo scope at github.com/settings/token")
...
with col1:
    repo = st.text_input("Repository ", value="Aridam200/awesome-ai-apps", help="Format:owner/repo")
with col2:
...
query = st.text_area("Your Query", value=query_template,
                    placeholder ="What would tou like to know about this repository")
                ...
                try:
                    async with ClientSession(read, write) as session:
                        ...
                        try:
                           ...
                           agent =Agent(
                             tools=[mcp_tool],
                             introduction=dedent("""\                                    You are a GitHub assistant. Help users explore repositories and their activity.
